/* C++ program to find the minimum length unsorted subarray, which makes the complete array sorted
...
void printUnsorted(int arr[], int n) {
    ...
    cout << "The unsorted subarray which makes the given array sorted lies between the indees " << s << " and " << e;
    return;
}
